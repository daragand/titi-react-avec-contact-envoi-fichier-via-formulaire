...
const Accompagnements = () => {
    ...
    useEffect(() => {
        fetch('https://titi.startwin.fr/products/type/accompagnement')
            .then(res => res.json())
            .then(data => setAccompagnements(data))
        ...
        <main className="optimal-width choice">
            ...
            <div className="main-grid" id="nos-burgers">
                <form id="burger-form" onSubmit={handleSubmit}>
                    {accompagnements.map((accompagnement, index) => (
                        <Product product={accompagnement} setChoosedProduct={setChoosedProduct} />
                    ))}
                </form>
